...
func (Moderator_Fee_FeeType) EnumDescriptor() ([]byte, []int) { return fileDescriptor5, []int{0, 0, 0} }
...
func (*Moderator) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{0} }
...
func (*Moderator_Fee) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{0, 0} }
...
func (*Moderator_Price) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{0, 1} }
...
func (*DisputeUpdate) Descriptor() ([]byte, []int) { return fileDescriptor5, []int{1} }
...
func init() { proto.RegisterFile("moderator.proto", fileDescriptor5) }
